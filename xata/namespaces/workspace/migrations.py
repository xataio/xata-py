...
class Migrations(Namespace):
    ...
    def executeBranchMigrationPlan(self, db_branch_name: str, payload: dict) -> Response:
       """
    ...
    def compareBranchWithUserSchema(self, db_branch_name: str, payload: dict) -> Response:
       """
    ...
    def compareBranchSchemas(self, db_branch_name: str, branch_name: str, payload: dict) -> Response:
       """
