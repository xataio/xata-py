...
class Records(Namespace):
    ...
    def insertRecord(self, db_branch_name: str, table_name: str, columns: array, payload: dict) -> Response:
       """
       ...
       :param columns: array Column filters
       :param payload: dict Request Body
       :return Response
       """
    ...
    def getRecord(self, db_branch_name: str, table_name: str, record_id: str, columns: array) -> Response:
       """
    ...
    def insertRecordWithID(self, db_branch_name: str, table_name: str, record_id: str, columns: array, payload: dict) -> Response:
       """
    ...
    def upsertRecordWithID(self, db_branch_name: str, table_name: str, record_id: str, columns: array, payload: dict) -> Response:
       """
    ...
    def deleteRecord(self, db_branch_name: str, table_name: str, record_id: str, columns: array) -> Response:
       """
    ...
    def bulkInsertTableRecords(self, db_branch_name: str, table_name: str, columns: array, payload: dict) -> Response:
       """
       Bulk insert records
