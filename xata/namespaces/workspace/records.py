...
class Records(Namespace):
    ...
    def insertRecord(self, db_branch_name: str, table_name: str, columns: list, payload: dict) -> Response:
       """
    ...
    def getRecord(self, db_branch_name: str, table_name: str, record_id: str, columns: list) -> Response:
       """
    ...
    def insertRecordWithID(self, db_branch_name: str, table_name: str, record_id: str, columns: list, payload: dict) -> Response:
       """
    ...
    def upsertRecordWithID(self, db_branch_name: str, table_name: str, record_id: str, columns: list, payload: dict) -> Response:
       """
    ...
    def deleteRecord(self, db_branch_name: str, table_name: str, record_id: str, columns: list) -> Response:
       """
    ...
    def bulkInsertTableRecords(self, db_branch_name: str, table_name: str, columns: list, payload: dict) -> Response:
       """
       Bulk insert records
