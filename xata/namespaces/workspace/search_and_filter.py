...
class Search_and_filter(Namespace):
    ...
    def queryTable(self, db_branch_name: str, table_name: str, payload: dict) -> Response:
       """
...
```
    ...
    def searchTable(self, db_branch_name: str, table_name: str, payload: dict) -> Response:
       """
...
* filtering on columns of type `multiple` is currently unsupported
    ...
    def summarizeTable(self, db_branch_name: str, table_name: str, payload: dict) -> Response:
       """
...
will return the default size.
    ...
    def aggregateTable(self, db_branch_name: str, table_name: str, payload: dict) -> Response:
       """
