...
class Records(Namespace):
    ...
    def insert(self, table_name: str, payload: dict, db_name: str = None, branch_name: str = None, columns: list = None) -> Response:
       """
    ...
    def get(self, table_name: str, record_id: str, db_name: str = None, branch_name: str = None, columns: list = None) -> Response:
       """
    ...
    def insert_with_id(self, table_name: str, record_id: str, payload: dict, db_name: str = None, branch_name: str = None, columns: list = None, createOnly: bool = None, ifVersion: int = None) -> Response:
       """
    ...
    def upsert_with_id(self, table_name: str, record_id: str, payload: dict, db_name: str = None, branch_name: str = None, columns: list = None, ifVersion: int = None) -> Response:
       """
    ...
    def delete(self, table_name: str, record_id: str, db_name: str = None, branch_name: str = None, columns: list = None) -> Response:
       """
    ...
    def update_with_id(self, table_name: str, record_id: str, payload: dict, db_name: str = None, branch_name: str = None, columns: list = None, ifVersion: int = None) -> Response:
       """
    ...
    def bulk_insert(self, table_name: str, payload: dict, db_name: str = None, branch_name: str = None, columns: list = None) -> Response:
       """
       Bulk insert records
